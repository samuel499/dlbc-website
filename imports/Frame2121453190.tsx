import svgPaths from "./svg-75nplmhdea";

function Group1() {
  return (
    <div className="absolute inset-[9.06%_82.47%_60.76%_6.58%]">
...
export default function Frame2121453193() {
  return (
    <div className="bg-[#fdfdfd] relative size-full">
      ...
      <Frame2121453191 />
      <Frame2121453192 />
      <div className="absolute h-0 left-[64px] top-[620px] w-[1226px]">
        <div className="absolute inset-[-7px_-0.41%_-5px_-0.41%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1236 12">
            <g filter="url(#filter0_f_10_397)" id="Line 1">
              <line stroke="var(--stroke-0, #4CAFE8)" strokeOpacity="0.25" strokeWidth="2" x1="5" x2="1231" y1="6" y2="6" />
            </g>
            <defs>
              <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="12" id="filter0_f_10_397" width="1236" x="0" y="0">
                <feFlood floodOpacity="0" result="BackgroundImageFix" />
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" mode="normal" result="shape" />
                <feGaussianBlur result="effect1_foregroundBlur_10_397" stdDeviation="2.5" />
              </filter>
            </defs>
          </svg>
        </div>
      </div>
      <div className="absolute h-0 left-[64px] top-[890px] w-[1226px]">
        <div className="absolute inset-[-7px_-0.41%_-5px_-0.41%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1236 12">
            <g filter="url(#filter0_f_10_397)" id="Line 1">
              <line stroke="var(--stroke-0, #4CAFE8)" strokeOpacity="0.25" strokeWidth="2" x1="5" x2="1231" y1="6" y2="6" />
      ...
      <div className="absolute h-0 left-[64px] top-[1160px] w-[1226px]">
        <div className="absolute inset-[-7px_-0.41%_-5px_-0.41%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1236 12">
            <g filter="url(#filter0_f_10_397)" id="Line 1">
              <line stroke="var(--stroke-0, #4CAFE8)" strokeOpacity="0.25" strokeWidth="2" x1="5" x2="1231" y1="6" y2="6" />
