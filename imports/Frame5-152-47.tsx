import svgPaths from "./svg-q4tqebegkv";
...
function Frame2121453187() {
  return (
    <div className="absolute h-[71px] italic leading-[normal] left-[150px] text-[#2d2d2d] top-[874px] w-[483px]">
      <p className="absolute font-['TacticSans-RegIt:Italic',_sans-serif] h-[21px] left-[calc(50%-241.5px)] text-[18px] top-[50px] w-[483px]">General Superintendent, Deeper Life Bible Church</p>
      <p className="absolute font-['TacticSans-MedIt:Italic',_sans-serif] h-[42px] left-[calc(50%-236.5px)] text-[36px] top-0 w-[473px]">PASTOR DR W.F KUMUYI</p>
    </div>
  );
}
...
export default function Frame5() {
  return (
    <div className="bg-[rgba(28,78,128,0.08)] relative size-full">
      <p className="absolute font-['TacticSans-UltIt:Italic',_sans-serif] h-[226px] italic leading-[normal] left-[calc(50%+162px)] text-[#2d2d2d] text-[96px] top-[80px] w-[510px]">What We Believe”</p>
      <p className="absolute font-['TacticSans-MedIt:Italic',_sans-serif] h-[464px] italic leading-[normal] left-[calc(50%+672px)] text-[#2d2d2d] text-[48px] text-right top-[494px] translate-x-[-100%] w-[802px]">
        “All scripture is given by inspiration of God, and is profitable for doctrine, for reproof, for correction, for instruction in righteousness:
        <br aria-hidden="true" />
        {` That the man of God may be perfect, throughly furnished unto all good works.”`}
      </p>
      <p className="absolute font-['TacticSans-MedIt:Italic',_sans-serif] h-[42px] italic leading-[normal] left-[calc(50%+672px)] text-[#1c4e80] text-[36px] text-right top-[982px] translate-x-[-100%] w-[466px]">Timothy 3:16–17 (KJV)</p>
      <p className="absolute font-['TacticSans-RegIt:Italic',_sans-serif] h-[116px] italic leading-[normal] left-[calc(50%-399px)] text-[#2d2d2d] text-[24px] text-center top-[330px] translate-x-[-50%] w-[546px]">We take the Bible as the final authority in all matters concerning Christian life and practice. Learn about the core doctrines that guide our teaching and worship.</p>
      <ImageContent />
