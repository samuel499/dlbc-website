...
function Group2() {
  return (
    <div className="absolute contents left-[48px] top-[42px]">
      <div className="absolute inset-[9.05%_91.46%_86.64%_6.03%]" data-name="Vector">
...
function Group4() {
  return (
    <div className="absolute contents left-[383px] top-[33px]">
      ...
      <div className="absolute aspect-[16/19.9825] left-[48.12%] right-[49.62%] top-[calc(50%-180px)] translate-y-[-50%]" data-name="Vector">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 22">
          <path d={svgPaths.p17fa5700} fill="var(--fill-0, #4CAFE8)" id="Vector" />
        </svg>
      </div>
    </div>
  );
...
function ArrowRight() {
  return (
    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
      <g id="arrow-right">
        <path d={svgPaths.p30185600} id="Vector" stroke="var(--stroke-0, #4CAFE8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        <path d="M8.50006 11.9995H14.5001" id="Vector_2" stroke="var(--stroke-0, #4CAFE8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        <path d={svgPaths.p1732a00} id="Vector_3" stroke="var(--stroke-0, #4CAFE8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
...
function Frame2147226740() {
  return (
    <div className="absolute h-[570px] left-[calc(50%-169px)] top-[602px] translate-x-[-50%] w-[1006px]">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[182.05%] left-[0.38%] max-w-none top-[0.85%] w-full" src={imgFrame2121453211} />
      </div>
    </div>
...
function Group6() {
  return (
    <div className="absolute contents left-1/2 top-[602px] translate-x-[-50%]">
      <Frame2147226740 />
      <Frame2147226741 />
    </div>
  );
...
function Frame2147226742() {
  return (
    <div className="absolute h-[570px] left-[calc(50%-169px)] top-[1204px] translate-x-[-50%] w-[1006px]">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[182.05%] left-[0.38%] max-w-none top-[0.85%] w-full" src={imgFrame2121453211} />
      </div>
    </div>
...
function ArrowRight2() {
  return (
    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
      <g id="arrow-right">
        <path d={svgPaths.p14652b80} id="Vector" stroke="var(--stroke-0, #4CAFE8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        <path d="M8.5001 11.9996H14.5001" id="Vector_2" stroke="var(--stroke-0, #4CAFE8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        <path d={svgPaths.p3e15bf40} id="Vector_3" stroke="var(--stroke-0, #4CAFE8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        <g id="Vector_4" opacity="0"></g>
      </g>
    </svg>
  );
...
function Group7() {
  return (
    <div className="absolute contents left-1/2 top-[1204px] translate-x-[-50%]">
      <Frame2147226742 />
      <Frame2147226743 />
    </div>
  );
...
export default function Frame2147226745() {
  return (
