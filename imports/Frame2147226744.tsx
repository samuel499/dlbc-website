...
function NavMenu() {
  return (
    <div className="absolute content-stretch flex font-['Plus_Jakarta_Sans:Regular',_sans-serif] font-normal gap-[40px] items-center leading-[normal] left-1/2 text-[16px] text-nowrap text-white top-[54px] translate-x-[-50%] whitespace-pre" data-name="Nav menu">
      ...
      <p className="relative shrink-0">Sermons</p>
...
function Frame2121453184() {
  return (
    <div className="absolute h-[128px] left-0 top-0 w-[1440px]">
      <div className="h-[128px] overflow-clip relative rounded-[inherit] w-[1440px]">
        <NavMenu />
        <Frame1116607059 />
      </div>
      ...
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.7666651606559753)+(var(--transform-inner-height)*0.6420471668243408)))] items-center justify-center left-[55.24px] top-[calc(50%+18.969px)] translate-y-[-50%] w-[calc(1px*((var(--transform-inner-height)*0.7666651606559753)+(var(--transform-inner-width)*0.6420471668243408)))]" style={{ "--transform-inner-width": "57", "--transform-inner-height": "46" } as React.CSSProperties}>
        <div className="flex-none rotate-[50.055deg]">
          <div className="h-[46px] relative w-[57px]" data-name="dlbc 1">
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <img alt="" className="absolute h-[111.38%] left-0 max-w-none top-[-0.26%] w-full" src={imgDlbc1} />
            </div>
          </div>
        </div>
      </div>
...
export default function Frame2147226744() {
  return (
