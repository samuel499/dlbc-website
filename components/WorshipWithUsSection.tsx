...
function ServiceCard({ 
  ...
  return (
    ...
    >
      ...
      >
        <div className={`${dayBg} h-[90px] md:h-[100px] relative w-[280px] md:w-[300px]`}>
          <div className="h-full overflow-clip relative rounded-[inherit] w-full">
            <p className={`absolute font-['TacticSans-UltIt:Italic', sans-serif] italic leading-[normal] text-[36px] md:text-[44px] text-white text-center left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2`}>
              {day}
            </p>
          </div>
      ...
      {/* Card Body */}
      <motion.div 
        className={`relative ${hasShadow ? 'bg-[#f4faf8] shadow-[0px_0px_40px_10px_rgba(76,175,232,0.25)]' : 'bg-[#fdfdfd]'} w-full p-8 md:p-10 rounded-lg border border-gray-100`}
      ...
      >
        ...
        <motion.p 
          className="font-['TacticSans-RegIt:Italic', sans-serif] italic leading-[1.3] text-[#2d2d2d] text-[18px] sm:text-[20px] md:text-[24px] mb-6 md:mb-8"
          animate={isHovered ? { x: 8 } : { x: 0 }}
        ...
        >
          ...
          <div className="absolute font-['TacticSans-MedIt:Italic', sans-serif] italic leading-[1.2] text-[18px] md:text-[20px] text-center text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120px]">
