...
function NavMenu() {
  ...
  return (
    <>
      {/* Desktop Navigation */}
      <div className="hidden lg:flex absolute content-stretch font-['Plus_Jakarta_Sans:Regular', sans-serif] font-normal gap-5 xl:gap-10 items-center leading-[normal] left-1/2 text-[14px] xl:text-4 text-nowrap text-white top-11 md:top-[54px] translate-x-[-50%] whitespace-pre z-20" data-name="Nav menu">
        {menuItems.map((item) => (
          <p 
            key={item.id}
...
function Frame1116607029() {
  return (
    <div className="bg-[#4cafe8] box-border content-stretch flex gap-2.5 h-10 md:h-12 items-center justify-center px-5 md:px-[26px] py-2.5 md:py-3 relative rounded-[100px] shrink-0 cursor-pointer hover:bg-[#3ba3d9] transition-colors">
      <p className="font-['Plus_Jakarta_Sans:SemiBold', sans-serif] font-semibold leading-[normal] relative shrink-0 text-4 md:text-[18px] text-nowrap text-white whitespace-pre">View Live</p>
    </div>
  );
}
...
function Frame1116607030() {
  ...
  return (
    ...
    >
      ...
      <p className="font-['Plus_Jakarta_Sans:SemiBold', sans-serif] font-semibold leading-[normal] relative shrink-0 text-4 md:text-[18px] text-nowrap text-white whitespace-pre">Discover More</p>
    </motion.div>
  );
}
...
function Frame2() {
  return (
    <div className="bg-[#1c4e80] h-20 md:h-[100px] lg:h-[143.534px] overflow-clip relative w-40 md:w-[200px] lg:w-[307.178px]">
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.7666651606559753)+(var(--transform-inner-height)*0.6420471668243408)))] items-center justify-center left-[30px] md:left-10 lg:left-[55.24px] top-[calc(50%+14px)] md:top-[calc(50%+16px)] lg:top-[calc(50%+18.969px)] translate-y-[-50%] w-[calc(1px*((var(--transform-inner-height)*0.7666651606559753)+(var(--transform-inner-width)*0.6420471668243408)))]" style={{ "--transform-inner-width": "57", "--transform-inner-height": "46" } as React.CSSProperties}>
...
function ScrollingText() {
  ...
  return (
    <div className="absolute bg-[#4cafe8] h-10 md:h-[60px] left-0 overflow-hidden top-0 w-full z-30">
      ...
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.7666651606559753)+(var(--transform-inner-height)*0.6420471668243408)))] items-center justify-center left-[-50px] lg:left-[-78.6px] top-[-100px] md:left-[-120px] lg:top-[-193.86px] w-[calc(1px*((var(--transform-inner-height)*0.7666651606559753)+(var(--transform-inner-width)*0.6420471668243408)))]" style={{ "--transform-inner-width": "307.171875", "--transform-inner-height": "143.53125" } as React.CSSProperties}>
