...
function NavMenu() {
  ...
  return (
    <>
      {/* Desktop Navigation */}
      <div className="hidden lg:flex absolute content-stretch font-['Plus_Jakarta_Sans:Regular', sans-serif] font-normal gap-[20px] xl:gap-[40px] items-center leading-[normal] left-1/2 text-[14px] xl:text-[16px] text-nowrap text-white top-[44px] md:top-[54px] translate-x-[-50%] whitespace-pre z-20" data-name="Nav menu">
        {menuItems.map((item) => (
          <p 
            key={item.id}
        ...
        >
          <div className="flex flex-col gap-8 text-center">
            {menuItems.map((item) => (
              <p 
                key={item.id}
                className="font-['Plus_Jakarta_Sans:Regular', sans-serif] text-[24px] text-white cursor-pointer hover:text-[#4cafe8] transition-colors" 
                onClick={() => scrollToSection(item.id)}
              >
                {item.label}
              </p>
...
function Frame1116607029() {
  return (
    <div className="bg-[#4cafe8] box-border content-stretch flex gap-[10px] h-[40px] md:h-12 items-center justify-center px-[20px] md:px-[26px] py-2.5 md:py-3 relative rounded-[100px] shrink-0 cursor-pointer hover:bg-[#3ba3d9] transition-colors">
      <p className="font-['Plus_Jakarta_Sans:SemiBold', sans-serif] font-semibold leading-[normal] relative shrink-0 text-[16px] md:text-[18px] text-nowrap text-white whitespace-pre">View Live</p>
    </div>
  );
}
...
function Frame1116607030() {
  ...
  return (
    <motion.div 
      className="relative w-full md:w-auto md:absolute box-border content-stretch flex gap-[10px] h-[48px] items-center justify-center left-0 md:left-0 px-[26px] py-3 rounded-[100px] md:top-[257px] mb-4 md:mb-0 cursor-pointer mx-auto md:mx-0 max-w-[200px] md:max-w-none"
    ...
    >
      ...
      <p className="font-['Plus_Jakarta_Sans:SemiBold', sans-serif] font-semibold leading-[normal] relative shrink-0 text-[16px] md:text-[18px] text-nowrap text-white whitespace-pre">Discover More</p>
    </motion.div>
  );
}
...
function Frame2121453185() {
  return (
    <div className="relative md:absolute h-auto md:h-[305px] left-0 md:left-12 px-4 md:px-0 top-20 sm:top-[120px] md:top-[483px] w-full md:w-[531px] flex flex-col">
      ...
      <motion.p 
        className="font-['TacticSans-Reg:Regular', sans-serif] h-auto md:h-[87px] leading-[1.4] md:leading-[normal] not-italic text-[16px] sm:text-[20px] md:text-[24px] text-white w-full md:w-[487px] mb-4 md:mb-0 md:absolute md:left-0 md:top-[158px] order-2"
  ...
  return (
    <div className="absolute h-[600px] md:h-[860px] left-0 overflow-clip top-[40px] md:top-[60px] w-full">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
        <Image alt="" className="absolute max-w-none object-center md:object-50%-50% object-cover size-full" src={imgFrame4} />
    ...
    <div className="bg-[#1c4e80] h-20 md:h-[100px] lg:h-[143.534px] overflow-clip relative w-40 md:w-[200px] lg:w-[307.178px]">
      <div className="absolute flex h-[calc(1px*((var(--transform-inner-width)*0.7666651606559753)+(var(--transform-inner-height)*0.6420471668243408)))] items-center justify-center left-[30px] md:left-[40px] lg:left-[55.24px] top-[calc(50%+14px)] md:top-[calc(50%+16px)] lg:top-[calc(50%+18.969px)] translate-y-[-50%] w-[calc(1px*((var(--transform-inner-height)*0.7666651606559753)+(var(--transform-inner-width)*0.6420471668243408)))]" style={{ "--transform-inner-width": "57", "--transform-inner-height": "46" } as React.CSSProperties}>
        <div className="flex-none rotate-[50.055deg]">
          <div className="h-9 md:h-[42px] lg:h-[46px] relative w-11 md:w-[52px] lg:w-[57px]" data-name="dlbc 1">
  ...
  return (
    <div className="absolute bg-[#4cafe8] h-[40px] md:h-[60px] left-0 overflow-hidden top-0 w-full z-30">
      <div className="absolute flex items-center h-full">
        ...
        >
          <p className="font-['Italianno:Regular', sans-serif] text-[16px] md:text-[20px] lg:text-[24px] text-white px-4 md:px-6 lg:px-8">
            {text}
          </p>
          <p className="font-['Italianno:Regular', sans-serif] text-[16px] md:text-[20px] lg:text-[24px] text-white px-4 md:px-6 lg:px-8">
            {text}
